...
```scala
//ZIO
libraryDependencies += "com.github.valskalla" %% "odin-zio" % "0.8.0"
//or Monix
libraryDependencies += "com.github.valskalla" %% "odin-monix" % "0.8.0"
```
...
//   source = Bind(
//     source = Delay(
//       thunk = cats.effect.Clock$$anon$1$$Lambda$9017/1333934411@5f806410
//     ),
//     f = io.odin.loggers.DefaultLogger$$Lambda$9018/1270423602@2b882d06
//   ),
//   f = scala.Function1$$Lambda$9025/1287069601@5f8b169d,
//   index = 1
// )
...
// 2020-08-12T08:57:28,795 [run-main-0] INFO repl.MdocSession.App#res1:65 - Hello world
```
...
// 2020-08-12T08:57:28,833 [run-main-0] INFO repl.MdocSession.App#res2:71 - No context
// 2020-08-12T08:57:28,833 [run-main-0] INFO repl.MdocSession.App#res2:71 - Some context - key: value
```
...
// {"level":"INFO","message":"This is JSON","context":{},"exception":null,"position":"repl.MdocSession.App#res3:86","thread_name":"run-main-0","timestamp":"2020-08-12T08:57:28,868"}
```
...
// fileNamePattern: LocalDateTime => String = io.odin.config.package$FileNamePatternInterpolator$$$Lambda$9040/1208752213@61de357a
val fileName = fileNamePattern(LocalDateTime.now)
// fileName: String = "/var/log/2020-08-12-08-57-28.log"
```
...
// 2020-08-12T08:57:29,482 [run-main-0] INFO repl.MdocSession.App#res11:169 - Async info
```
...
// 2020-08-12T08:57:29,528 [run-main-0] INFO repl.MdocSession.App#res12:233 - Hello world - predefined: context
```
...
consoleLogger[M]()
    ...
    .run(Env(Map("env" -> "ctx")))
    .unsafeRunSync()
// 2020-08-12T08:57:29,609 [run-main-0] INFO repl.MdocSession.App#res13:264 - Hello world - env: ctx
```
...
consoleLogger[IO]()
    ...
    .info("Hello")
    .unsafeRunSync()
// 2020-08-12T08:57:29,615 [run-main-0] INFO repl.MdocSession.App#res14:277 - Hello World
...
```scala
libraryDependencies += "com.github.valskalla" %% "odin-extras" % "0.8.0"
```
...
// service: UserService[IO] = repl.MdocSession$App$UserService@6cb1d434

service.findAndVerify("good-user").attempt.unsafeRunSync()
// 2020-08-12T08:57:29,651 [run-main-0] INFO repl.MdocSession.App#UserService#findAndVerify:316 - User found and verified User(my-user-good-user)
// res16: Either[Throwable, Unit] = Right(value = ())
service.findAndVerify("bad-user").attempt.unsafeRunSync()
// 2020-08-12T08:57:29,654 [run-main-0] DEBUG repl.MdocSession.App#UserService#findAndVerify:312 - Looking for user by id [bad-user]
// 2020-08-12T08:57:29,654 [run-main-0] DEBUG repl.MdocSession.App#UserService#findAndVerify:314 - Found user User(my-user-bad-user)
...
- Add following dependency to your build:
```scala
libraryDependencies += "com.github.valskalla" %% "odin-slf4j" % "0.8.0"
```
