...
// res0: IO[Unit] = Map(
//   Bind(
//     Delay(cats.effect.Clock$$anon$1$$Lambda$8313/1937365130@5937523f),
//     io.odin.loggers.DefaultLogger$$Lambda$8314/1338650656@70792605
//   ),
//   scala.Function1$$Lambda$8321/417051948@7271111c,
//   1
// )
...
// 2019-12-03T15:57:29 [run-main-0] INFO repl.Session.App#res1:68 - Hello world
```
...
// 2019-12-03T15:57:29 [run-main-0] INFO repl.Session.App#res2:77 - No context
// 2019-12-03T15:57:29 [run-main-0] INFO repl.Session.App#res2:77 - Some context - key: value
```
...
// {"level":"INFO","message":"This is JSON","context":{},"exception":null,"position":"repl.Session.App#res3:92","thread_name":"run-main-0","timestamp":"2019-12-03T15:57:29"}
```
...
// 2019-12-03T15:57:30 [run-main-0] INFO repl.Session.App#res6 $anonfun:142 - Async info
```
...
// 2019-12-03T15:57:30 [run-main-0] INFO repl.Session.App#res7:206 - Hello world - predefined: context
```
...
consoleLogger[M]()
    ...
    .run(Env(Map("env" -> "ctx")))
    .unsafeRunSync()
// 2019-12-03T15:57:30 [run-main-0] INFO repl.Session.App#res8:237 - Hello world - env: ctx
```
...
consoleLogger[IO]()
    ...
    .info("Hello")
    .unsafeRunSync()
// 2019-12-03T15:57:30 [run-main-0] INFO repl.Session.App#res9:250 - Hello World
